...
const Pricing = () => {
  ...
  const plans = [
    {
      ...
      price: "2,999",
      monthlyPrice: "799",
      message: "for specific domain cost (monthly) varies",
      icon: Globe,
  ...
  const handleSelectPlan = (plan) => {
    ...
    setPlanMonthlySelection((prev) => ({
      ...prev,
      [plan.name]: chosenMonthly,
    }));
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://webshopagency.in/pricing" />
        ...
        <div className="relative container mx-auto px-4">
          <div className="text-center mb-16 max-w-3xl mx-auto">
            ...
            <p className="text-slate-300 text-lg">
              Choose a monthly rental plan that includes design, hosting,
              maintenance, and support. No large upfront investment required.
            </p>
          </div>
                  ...
                  <div className="p-8 bg-slate-900/75">
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center gap-3">
                        <div
                          className={`w-14 h-14 bg-linear-to-br ${plan.gradient} rounded-2xl flex items-center justify-center text-white`}
                        >
                          <Icon className="w-7 h-7" />
                        </div>
                        <div>
                          <p className="text-sm uppercase tracking-[0.24em] text-slate-500 mb-1">
                            {plan.site}
                          </p>
                    ...
                    <div className="mb-6">
                      ...
                      <p className="text-sm text-slate-400 mt-2">
                        One-time setup: ₹{plan.price}
                      </p>
                      <p className="text-sm text-slate-400 mt-2">{plan.message}</p>
                    </div>
          ...
          <div className="mt-16 grid gap-6 md:grid-cols-3 max-w-5xl mx-auto text-center">
            <div className="glass-card p-6">
              ...
              <p className="text-slate-300">
                We include secure hosting and backups as part of every rental
                plan.
              </p>
            </div>
            <div className="glass-card p-6">
              ...
              <p className="text-slate-300">
                Move from basic to full-stack when your business needs more
                features.
              </p>
            </div>
            <div className="glass-card p-6">
              ...
              <p className="text-slate-300">
                Maintenance, updates, and website changes are handled for you.
              </p>
            </div>
          </div>
          ...
          <div className="mt-12 text-center">
            <p className="text-slate-400 max-w-2xl mx-auto">
              * All prices are monthly rentals. Setup happens within 3-5
              business weeks.
              <span className="font-semibold text-slate-100">
                {" "}
                We maintain and host your website, you just provide content
                updates.
              </span>
            </p>
          </div>
